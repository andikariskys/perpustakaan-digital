    ...
    <div class="container-fluid py-2">
        <div class="card mb-3" style="max-width: 720px;">
            <div class="row no-gutters">
                <div class="col-md-3">
                    <center><img src="../assets/images/books-media/book-media-03.jpg" alt="..." style="max-width: 180px;"></center>
                </div>
                <div class="col-md-9">
                    <div class="card-body">
                        <h4 class="card-title"><strong>Pemrograman Web Modern</strong></h4>
