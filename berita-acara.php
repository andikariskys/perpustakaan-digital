                    ...
                    <section class="search-filters">
                        <div class="filter-box">
                            ...
                            <form action="http://libraria.demo.presstigers.com/index.php?page=detail-berita-acara" method="get">
                                ...
                                <div class="col-md-2">
                                            <div class="form-group">
                                                <input class="form-control btn-clearform" type="submit" value="Cari">
                                            </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="col-md-3 col-md-pull-9">
                            <aside id="secondary" class="sidebar widget-area">
                                <div class="widget widget_recent_entries">
                                    <h4 class="widget-title" data-control>Sering dikunjungi</h4>
                                    <ul>
                                        <li>
                                            <figure>
                                                <img src="assets/images/news-event/news-listing-01.jpg" alt="product" />
                                            </figure>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="assets/images/news-event/news-listing-02.jpg" alt="product" />
                                            </figure>
                                            <a href="#">It uses a dictionary</a>
                                            <span><i class="fa fa-calendar"></i> &nbsp; July 25, 2016</span>
                                            <span><i class="fa fa-clock-o"></i> &nbsp; 10:15 AM - 10:15 PM</span>
                                        ...
                                        <li>
                                            <figure>
                                                <img src="assets/images/news-event/news-listing-03.jpg" alt="product" />
                                            </figure>
                                            <a href="#">It uses a dictionary</a>
                                            <span><i class="fa fa-calendar"></i> &nbsp; July 25, 2016</span>
                                            <span><i class="fa fa-clock-o"></i> &nbsp; 10:15 AM - 10:15 PM</span>
