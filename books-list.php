                        ...
                        <section class="search-filters">
                            <div class="container">
                                <div class="filter-box">
                                    <h3>Apa yang Anda cari di perpustakaan?</h3>
                    ...
                    <div class="row">
                                        ...
                                        <div class="post-detail">
                                            <header class="entry-header">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <ul>
                                                            <li><strong>Kategori:</strong> First editio</li>
                                                            <li><strong>Penerbit:</strong> First editio</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </header>
                        ...
                        <div class="col-md-3 col-md-pull-9">
                            <aside id="secondary" class="sidebar widget-area" data-accordion-group>
                                <div class="widget widget_related_search open">
                                    <h4 class="widget-title" data-control>Sering dicari</h4>
                                    <div data-content>
                                        <div data-accordion>
                                            <h5 class="widget-sub-title" data-control>Kategori</h5>
                                        ...
                                        <div data-accordion>
                                            <h5 class="widget-sub-title" data-control>Pengarang</h5>
                                            <div class="widget_categories" data-content>
                                                <ul>
                                                    <li><a href="#">Love stories <span>(18)</span></a></li>
                                                    <li><a href="#">Texas <span>(04)</span></a></li>
                                        ...
                                        <div data-accordion>
                                            <h5 class="widget-sub-title" data-control>Penerbit</h5>
                                            <div class="widget_categories" data-content>
                                                <ul>
                                                    <li><a href="#">Love stories <span>(18)</span></a></li>
                                                    <li><a href="#">Texas <span>(04)</span></a></li>
